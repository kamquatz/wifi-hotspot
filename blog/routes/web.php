...
use App\Http\Livewire\Posts\Post;
...
Route::get('posts', \App\Http\Livewire\Posts\Posts::class);
Route::get('post/{id}', \App\Http\Livewire\Posts\Post::class);

Route::get('/home', 'App\Http\Controllers\PostController@index');
Route::get('/blog', 'App\Http\Controllers\PostController@index_one');
// Route::get('/home/posts', ['as' => 'home', 'uses' => 'App\Http\Controllers\PostController@index']);
