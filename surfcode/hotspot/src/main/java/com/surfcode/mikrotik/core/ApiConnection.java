package com.surfcode.mikrotik.core;

import com.surfcode.Init;
import java.util.List;
import java.util.Map;
import javax.net.SocketFactory;
import com.surfcode.mikrotik.impl.ApiConnectionImpl;
...
public abstract class ApiConnection implements AutoCloseable {
     ...
     */
   // public static final int DEFAULT_PORT = Init.MIKROTIK_PORT;
    /**
   ...
   // public static final int DEFAULT_TLS_PORT = 8729;
     ...
     * @throws com.surfcode.mikrotik.core.MikrotikApiException Thrown if there is a
     * problem connecting
     * @since 3.0
     */
     ...
     * @throws com.surfcode.mikrotik.core.MikrotikApiException Thrown if the API encounters an error on login.
     */
     ...
     * @throws com.surfcode.mikrotik.core.MikrotikApiException Thrown if the API encounters an error executing a command.
     */
     ...
     *
     * @throws com.surfcode.mikrotik.core.ApiConnectionException Thrown if there is a
