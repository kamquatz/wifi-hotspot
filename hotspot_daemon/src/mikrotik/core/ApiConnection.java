package mikrotik.core;

import java.util.List;
import java.util.Map;
import javax.net.SocketFactory;
import mikrotik.impl.ApiConnectionImpl;
import main.Init;
...
public abstract class ApiConnection implements AutoCloseable {
     ...
     * @throws mikrotik.core.MikrotikApiException Thrown if there is a
     * problem connecting
     * @since 3.0
     */
     ...
     * @throws mikrotik.core.MikrotikApiException Thrown if the API encounters an error on login.
     */
     ...
     * @throws mikrotik.core.MikrotikApiException Thrown if the API encounters an error executing a command.
     */
     ...
     *
     * @throws mikrotik.core.ApiConnectionException Thrown if there is a
